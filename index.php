...
<div class="container-fluid flex flex-col justify-center items-center text-white p-5"
     style="height: 400px; background-size: cover; background-position: center; position: relative;">
     <h1 class="font-weight-bold mb-3" style="color: black;">Web Poliklinik UDINUS</h1>
     <h5 style="color: black; font-weight: bold;">
    Sistem Layanan Kesehatan Universitas Dian Nuswantoro
</h5>
</div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="">Dokter</h3>
                        <p class="card-text">Dokter dan Staff yang melayani pasien di Poliklinik Udinus, silahkan login terlebih dahulu</p>
                        <div class="d-grid">
    ...
    <div class="container">
        ...
        <div class="testimonial-card my-4">
            <div class="card">
                <div class="card-content">
                    <div class="img-box">
                        <img src="assets/images/amba.jpg" alt="Client 1">
                    </div>
                    <div class="text-content">
                        <h6>DreamyBull</h6>
                        <p class="location">New York</p>
                        <p class="testimonial-text">Udinus Mantap, mempunyai poliklinik terbaik di semarang</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="testimonial-card my-4">
            <div class="card">
                <div class="card-content">
                    <div class="img-box">
                        <img src="assets/images/vincent.jpg" alt="Client 2">
                    </div>
                    <div class="text-content">
                        <h6>Vincent</h6>
                        <p class="location">Palembang</p>
                        <p class="testimonial-text">Gak nyesel jauh-jauh ke semarang</p>
                    </div>
                </div>
            </div>
        </div>
